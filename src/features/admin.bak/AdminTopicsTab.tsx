                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-1">
                      <button
                        ...
                        className="rounded-md px-2.5 py-1 font-amharic text-[12px] font-medium text-text-secondary transition-colors hover:bg-surface-raised hover:text-text-primary"
                      >
                        ጥቅሶች
                      </button>
                      <button
