...
import { TagVerseAttacher } from "./TagVerseAttacher";
...
export function AdminTagsTab() {
  ...
  const [attachingTo, setAttachingTo] = useState<TagOut | null>(null);
  const { data, isLoading, isError } = useTags({ page: 1, perPage: 200 });
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-1">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-md px-2.5 py-1 font-amharic text-[12px] font-medium text-text-secondary transition-colors hover:bg-surface-raised hover:text-text-primary"
                      >
